              ...
              if (isset($_SESSION['cart'])):
                ?>
                  <table class="table table-bordered">
                      ...
                      <?php foreach ($_SESSION['cart'] AS $ticker_id => $cart):
                        $ticker_link = "index.php?controller=cart&action=delete&id=".$ticker_id;
                        ?>
                          <tr>
                              <td>
                                <?php if (!empty($cart['avatar'])): ?>
                                    <img class="ticker-avatar img-responsive"
                                         src="assets/uploads/<?php echo $cart['avatar']; ?>" width="60"/>
                                <?php endif; ?>
                                  <div class="content-ticker">
                                      <a href="<?php echo $ticker_link; ?>" class="content-ticker-a">
                                        <?php echo $cart['name']; ?>
                                      </a>
                                  </div>
                              </td>
                              <td>
                              <span class="ticker-amount">
                                  <?php echo $cart['quantity']; ?>
                              </span>
                              </td>
                              <td>
                              <span class="ticker-price-payment">
                      ...
                      <?php endforeach; ?>
                      <tr>
                          <td colspan="5" class="ticker-total">
